...
function Tranzex() {
  ...
  const handleRowClick = async (id) => {
    try {
      const response = await axios.post('https://testapi.maxpay.kz/admin/tranzex/transactions/logs', { id });
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post('https://testapi.maxpay.kz/admin/tranzex/get-transactions', filters);
  ...
  useEffect(() => {
    fetchData(); 
  }, [page, idFilter, merchantIdFilter, operatorIdFilter, panFromFilter, panToFilter, mTxnIdFilter, oTxnIdFilter, amountFilter, currencyFilter, createdAtFilter, updatedAtFilter, typeFilter, holderFromFilter, holderToFilter, bankFromIdFilter, bankToIdFilter, statusFilter, userIdFilter, createdAtFrom, createdAtTo]);
    ...
    <React.StrictMode>
      ...
      <div className="table-wrapper">
        ...
        <div className="filter-row">
          ...
          <span>PAN From</span>
          <input type="text" value={panFromFilter} onChange={(e) => setPanFromFilter(e.target.value)} placeholder="PAN From" />
        </div>
        <div className="filter-row">
          <span>PAN To</span>
          <input type="text" value={panToFilter} onChange={(e) => setPanToFilter(e.target.value)} placeholder="PAN To" />
          <span>M TXN ID</span>
          <input type="text" value={mTxnIdFilter} onChange={(e) => setMTxnIdFilter(e.target.value)} placeholder="M TXN ID" />
          <span>O TXN ID</span>
          <input type="text" value={oTxnIdFilter} onChange={(e) => setOTxnIdFilter(e.target.value)} placeholder="O TXN ID" />
          <span>Amount</span>
          <input type="text" value={amountFilter} onChange={(e) => setAmountFilter(e.target.value)} placeholder="Amount" />
        </div>
        <div className="filter-row">
          <span>Currency</span>
          <input type="text" value={currencyFilter} onChange={(e) => setCurrencyFilter(e.target.value)} placeholder="Currency" />
          <span>Created At</span>
          <input type="text" value={createdAtFilter} onChange={(e) => setCreatedAtFilter(e.target.value)} placeholder="Created At" />
          <span>Updated At</span>
          <input type="text" value={updatedAtFilter} onChange={(e) => setUpdatedAtFilter(e.target.value)} placeholder="Updated At" />
          <span>Type</span>
          <input type="text" value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} placeholder="Type" />
        </div>
        <div className="filter-row">
          <span>Holder From</span>
          <input type="text" value={holderFromFilter} onChange={(e) => setHolderFromFilter(e.target.value)} placeholder="Holder From" />
          <span>Holder To</span>
          <input type="text" value={holderToFilter} onChange={(e) => setHolderToFilter(e.target.value)} placeholder="Holder To" />
          <span>Bank From ID</span>
          <input type="text" value={bankFromIdFilter} onChange={(e) => setBankFromIdFilter(e.target.value)} placeholder="Bank From ID" />
          <span>Bank To ID</span>
          <input type="text" value={bankToIdFilter} onChange={(e) => setBankToIdFilter(e.target.value)} placeholder="Bank To ID" />
        </div>
        <div className="filter-row">
          <span>Status</span>
